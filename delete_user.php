  ...
  <div class="card">
    ...
    <div class="card-body">
      <form method="post">
        ...
        <p><?php echo $temp['fname'] . " " . $temp['lname']; ?></p>
        <!-- Modal -->
          ...
          <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content  bg-success">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Removed User</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body text-dark">
                <p>User has been removed from system!</p>
              </div>
        ...
        <div class="modal fade" id="error-dialog" tabindex="-1" role="dialog" data-backdrop="false"
          ...
          <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content  bg-danger">
              ...
              <div class="modal-body text-dark">
                <p>Sorry, there is an error in removing user from system!</p>
              </div>
              <div class="modal-footer">
                <button type="button" onclick="location.href = 'users.php';" class="btn bg-dark text-white"
                        data-dismiss="modal">Close
